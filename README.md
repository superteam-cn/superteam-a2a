...
- 🚧 **Phase 4 PR-4c Knowledge Service Step 2c 待启动**（ASGI server + Card-driven + BM25 + scope resolver + visibility resolver · 依赖 PR-4b handlers · 1 周工作量）
- 📋 **Phase 4 PR-5 Knowledge Service Step 3 待启动**（7 Helm + RBAC + cert-manager + kind E2E + Dockerfile · 1 周工作量）
